# [rtorrent](https://github.com/rakshasa/rtorrent2) + [flood webui](https://github.com/jfurrow/flood) inside a docker container

[![Docker start and layers](https://images.microbadger.com/badges/image/hurlenko/rtorrent-flood.svg)](https://microbadger.com/images/hurlenko/rtorrent-flood)
![Docker Pulls](https://img.shields.io/docker/pulls/hurlenko/rtorrent-flood.svg)
![Docker Stars](https://img.shields.io/docker/stars/hurlenko/rtorrent-flood.svg)

[flood](https://github.com/jfurrow/flood) is a popular rtorrent client with a webui for ease of use.
...
docker create \
  ...
  -p 51413:51413 \
  -p 6881:6881/udp \
  -v </path/to/flood/config>:/config \
  -v </path/to/flood/downloads>:/downloads \
  --restart unless-stopped \
  hurlenko/rtorrent-flood
```
...
* image version number
  * `docker inspect -f '{{ index .Config.Labels "build_version" }}' hurlenko/rtorrent-flood`